package java_1121;//package java_1030.java;
...
//        query("计算机系2019级1班");
    ...
    public static List<Info> query(String name) {
        ...
        try {
            ...
            // 创建数据库连接
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/test?user=root&password=chen62487&useUnicode=true&characterEncoding=UTF-8&useSSL=false");
